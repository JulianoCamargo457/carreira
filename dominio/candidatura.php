 <?php
  class Candidatura {
	 ...
	 * @return mixed
	 */
	public function getRequitos() {
		return $this->requitos;
	}
	
	/**
	 * @param mixed $requitos 
	 * @return self
	 */
	public function setRequitos($requitos): self {
	 ...
	 * @return mixed
	 */
	public function getDisponibilidadivate() {
		return $this->disponibilidadivate;
	}
	
	/**
	 * @param mixed $disponibilidadivate 
	 * @return self
	 */
	public function setDisponibilidadivate($disponibilidadivate): self {
		$this->disponibilidadivate = $disponibilidadivate;
		return $this;
	}
}